...
class EventsHandler {
    ...
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const files = yield (0, files_1.loadFiles)('./src/events/');
                for (const file of files) {
                    const { default: Event } = yield Promise.resolve(`${path_1.default.join(__dirname, '../../../', file)}`).then(s => __importStar(require(s)));
