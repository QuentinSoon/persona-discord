...
const commands_1 = require("../../components/commands/commands");
...
class CommandsHandler {
    ...
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const files = yield (0, files_1.loadFiles)('./src/commands/');
                for (const file of files) {
                    const { default: Command } = yield Promise.resolve(`${path_1.default.join(__dirname, '../../../', file)}`).then(s => __importStar(require(s)));
    ...
    registerApplicationCommands() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data1 = yield rest.put(discord_js_1.Routes.applicationCommands(process.env.CLIENT_ID), {
